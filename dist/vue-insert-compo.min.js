...
var InsertCompo = function () {
  function InsertCompo(Compo, userOpts) {
    ...
    _utils2.default.checkCompo(Compo);
    ...
    get: function get() {
      ...
      if (!this.$instance) {
        ...
        this.$instance.$watch('enable', function (val) {
          if (!_this.hideEl) return;

          if (val) {
            _utils2.default.hideEl(_this.hideEl);
          } else {
            _utils2.default.showEl(_this.hideEl);
          }
        });
      }
...
exports.default = {
  ...
  checkCompo: function checkCompo(Compo) {
    var defaultData = typeof Compo.data !== 'function' ? Compo.data : /* istanbul ignore next */Compo.data();
