(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["VueInsertCompo"] = factory();
	else
		root["VueInsertCompo"] = factory();
})(this, function() {
...
var DEFAULT_OPTS = {
  ...
  hideApp: false,
  wrapperTag: 'div',
  beforeEnable: function beforeEnable() {},
  afterEnable: function afterEnable() {},
  beforeDisable: function beforeDisable() {},
  afterDisable: function afterDisable() {}
};
...
var InsertCompo = function () {
  function InsertCompo(Compo, userOpts) {
    _classCallCheck(this, InsertCompo);

    this.Compo = Compo;
    this.update(userOpts);
  }

  _createClass(InsertCompo, [{
    key: 'update',
    value: function update(val) {
      this.opts = Object.assign({}, DEFAULT_OPTS, val);

      var appEl = this.opts.appEl;
    ...
    key: 'setCompoProp',
    value: function setCompoProp(key, val) {
    ...
    get: function get() {
      ...
      if (!this.$instance) {
        var el = document.createElement(this.opts.wrapperTag);
        elBody.appendChild(el);

        this.$instance = new _vue2.default(Object.assign({}, { el: el }, this.Compo));

        this.$instance.$watch('enable', function (val) {
          if (!_this3.opts.hideApp) return;

          if (val) {
            hideAppEl(_this3.appEl);
          } else {
            showAppEl(_this3.appEl);
          }
        });
      }
